      ...
      <div className="w-full md:w-full lg:w-1/2 xl:w-1/2 flex items-center lg:pr-10">
        <div>
          ...
          <p className="section-content">
            At TechLearns Academy, we believe in revolutionizing education through cutting-edge features that empower both educators and students.  Join us in reshaping the future of education – where creativity, collaboration, and innovation converge for a better learning experience.
          </p>
