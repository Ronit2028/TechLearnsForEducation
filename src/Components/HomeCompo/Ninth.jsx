  ...
  return (
    <>
      <div className="lg:w-4/5 mx-auto rounded-lg py-5">
        <div className="flex flex-wrap w-full pt-16 pb-16 relative mb-4">
          ...
          <div className="text-start relative z-10 w-full px-12">
            <h1 className="text-5xl w-3/5 text-gray-900 font-medium title-font mb-2 pt-12 pb-2">Ready to get started with Techlearns for Education?</h1>
