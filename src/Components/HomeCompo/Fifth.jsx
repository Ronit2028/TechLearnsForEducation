                ...
                <div className="container px-5 py-24 mx-auto ">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap bg-blue-950 rounded-lg">
                        <div className="lg:w-1/2 w-full lg:px-10 lg:py-32 mt-6 lg:mt-0">
                            <h1 className="text-gray-100 text-3xl title-font font-medium mb-3">Canva your Classroom</h1>

                            <p className=" text-gray-100 leading-relaxed">Design the best school year yet with Canva. Organise your ideas and engage your students with free, fun, and teacher-tested tools — from the first day to the final bell.
                            </p>
